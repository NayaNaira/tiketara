...
<head>
    ...
    <title>Verifikasi Email Anda - Tiketara</title>
    <style>
...
<body>
    <div class="container">
        <div class="box">
            ...
            <p>Terima kasih telah bergabung dengan Tiketara. Untuk mulai menggunakan semua fitur kami, termasuk mendaftar sebagai Promoter, silakan verifikasi alamat email Anda dengan mengeklik tombol di bawah ini.</p>
            
            <a href="{{ $url }}" class="btn">Verifikasi Email Sekarang</a>
            
            <p>Jika Anda tidak merasa mendaftar di Tiketara, Anda dapat mengabaikan email ini.</p>

            <div class="link-text">
                Jika Anda kesulitan mengeklik tombol "Verifikasi Email Sekarang", salin dan tempel URL di bawah ini ke browser web Anda:<br>
